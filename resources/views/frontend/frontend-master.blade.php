...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/')}}fronted/style.css">
...
<script src="{{asset('/')}}fronted/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="{{asset('/')}}fronted/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="{{asset('/')}}fronted/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="{{asset('/')}}fronted/js/bxslider.min.js"></script>
<script type="text/javascript" src="{{asset('/')}}fronted/js/script.slider.js"></script>
</body>
</html>
